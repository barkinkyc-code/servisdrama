...
async function _sendTruck(co){
  ...
  fetch('/api/send-test-mail',{
    ...
    body:JSON.stringify({
      ...
      attachmentNames:['drama-makine-logo','icon-phone','icon-mail','icon-linkedin','icon-youtube','icon-instagram','icon-web','icon-pin','icon-shield','icon-check','icon-headset','icon-calendar','icon-clock']
    })
  })
...
function buildTruckServiceMailHTML(customerName,technicianCode,technicianName,plannedDate,estimatedTime,estimatedMinutes,technicianPhone,technicianEmail,lastVisitDate,notes,extraNote){
  ...
  function infoCard(icon,label,value,valueColor){
    return '<td width="50%" valign="top" style="padding:0 8px 12px 0;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#F7FAFE; border:1px solid #E3EAF3;"><tr><td style="padding:16px;"><table role="presentation" width="34" height="34" cellspacing="0" cellpadding="0" border="0" style="width:34px; height:34px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:'+icon+'" width="16" height="16" alt="" style="width:16px; height:16px; margin:0 auto; display:block;"></td></tr></table><div style="margin-top:10px; color:#8093B5; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; font-weight:700; letter-spacing:0.5px; text-transform:uppercase;">'+label+'</div><div style="margin-top:3px; color:'+(valueColor||'#0F1937')+'; font-family:Arial, Helvetica, sans-serif; font-size:15.5px; line-height:20px; font-weight:700;">'+value+'</div></td></tr></table></td>';
  }
  var infoCards=[
    infoCard('icon-shield','Ziyaret Türü','Teknik Servis Ziyareti'),
    infoCard('icon-calendar','Planlanan Tarih',esc(plannedDate)),
    infoCard('icon-clock','Durum',esc(statusText),'#0AA443')
  ];
  if(lastVisitDate)infoCards.push(infoCard('icon-clock','Son Ziyaret',esc(lastVisitDisplay)));
  var infoCardsHtml='<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">';
  for(var ci=0;ci<infoCards.length;ci+=2){
    infoCardsHtml+='<tr>'+infoCards[ci]+(infoCards[ci+1]||'<td width="50%">&nbsp;</td>')+'</tr>';
  }
  infoCardsHtml+='</table>';
  var notesHtml=notes?'<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#F7FAFE; border:1px solid #E3EAF3; margin-top:4px;"><tr><td style="padding:16px; color:#8093B5; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; font-weight:700; letter-spacing:0.5px; text-transform:uppercase;">Notlar<div style="margin-top:5px; color:#171717; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:22px; font-weight:400; text-transform:none; letter-spacing:normal;">'+esc(notes)+'</div></td></tr></table>':'';

  return '<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="x-apple-disable-message-reformatting"><meta name="format-detection" content="telephone=no,address=no,email=no,date=no,url=no"><title>Teknik Servis Ziyareti</title><!--[if mso]><noscript><xml><o:OfficeDocumentSettings xmlns:o="urn:schemas-microsoft-com:office:office"><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml></noscript><![endif]--><style>body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }table { border-collapse: collapse !important; }img { -ms-interpolation-mode: bicubic; border: 0; outline: none; text-decoration: none; display: block; }a { color: inherit; }.mobile-pad { padding-left: 40px !important; padding-right: 40px !important; }@media only screen and (max-width: 640px) {.email-shell { width: 100% !important; }.mobile-pad { padding-left: 22px !important; padding-right: 22px !important; }.top-logo { width: 148px !important; height: auto !important; }.top-label { font-size: 12px !important; letter-spacing: 1px !important; padding: 10px 12px !important; }.hero-title { font-size: 34px !important; line-height: 40px !important; }.hero-subtitle { font-size: 17px !important; line-height: 25px !important; }.body-copy { font-size: 17px !important; line-height: 29px !important; }.data-label { width: 42% !important; font-size: 15px !important; }.data-value { font-size: 15px !important; }.contact-label { width: 35% !important; font-size: 14px !important; }.contact-value { font-size: 14px !important; }.footer-col { display: block !important; width: 100% !important; padding: 0 0 22px !important; border-left: 0 !important; }.trust-col { display: block !important; width: 100% !important; padding: 0 0 18px !important; }}</style></head><body style="margin:0; padding:0; background-color:#F3F6FA; font-family:Arial, Helvetica, sans-serif; color:#101C3D;"><div style="display:none; max-height:0; overflow:hidden; opacity:0; color:transparent;">Planlanan teknik servis ziyaretiniz ve tahmini varış bilgisi.</div><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%; background-color:#F3F6FA;"><tr><td align="center" style="padding:18px 8px;"><table role="presentation" class="email-shell" width="680" cellspacing="0" cellpadding="0" border="0" style="width:680px; max-width:680px; background-color:#FFFFFF; border:1px solid #E3EAF3;"><tr><td class="mobile-pad" style="padding:24px 40px; background-color:#FFFFFF;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td valign="middle"><img class="top-logo" src="cid:drama-makine-logo" width="165" alt="Drama Makine" style="width:165px; height:auto;"></td><td align="right" valign="middle"><span class="top-label" style="display:inline-block; padding:11px 15px; border:1px solid #0C2D67; color:#0F43B7; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:16px; font-weight:700; letter-spacing:1.3px; white-space:nowrap;">TEKNİK SERVİS BİLDİRİMİ</span></td></tr></table></td></tr><tr><td class="mobile-pad" style="padding:38px 40px 42px; background-color:#062B5A;"><div style="font-family:Arial, Helvetica, sans-serif; color:#27A4FF; font-size:15px; line-height:20px; font-weight:700; letter-spacing:4px;">SERVİSDRAMA</div><h1 class="hero-title" style="margin:20px 0 14px; color:#FFFFFF; font-family:Arial, Helvetica, sans-serif; font-size:43px; line-height:49px; font-weight:700; letter-spacing:-0.7px;">Teknik Servis Ziyareti</h1><p class="hero-subtitle" style="margin:0; color:#FFFFFF; font-family:Arial, Helvetica, sans-serif; font-size:19px; line-height:28px; font-weight:400;">Planlanan ziyaretiniz hakkında bilgilendirme</p></td></tr><tr><td class="mobile-pad" style="padding:34px 40px 0; background-color:#FFFFFF;"><p class="body-copy" style="margin:0 0 18px; color:#161616; font-family:Arial, Helvetica, sans-serif; font-size:19px; line-height:31px; font-weight:400;">Sayın <strong style="font-weight:700;">'+firmaDisplay+',</strong></p><p class="body-copy" style="margin:0; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:18px; line-height:31px; font-weight:400;">Sizi ve ürünümüzü önemsiyoruz. Sizlere daha iyi hizmet sunabilmek için teknik servis ekibimiz bugün firmanızı ziyaret etmek üzere yola çıkmıştır.</p></td></tr><tr><td class="mobile-pad" style="padding:28px 40px 0; background-color:#FFFFFF;">'+infoCardsHtml+notesHtml+'</td></tr><tr><td class="mobile-pad" style="padding:28px 40px 14px; background-color:#FFFFFF;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td style="height:1px; background-color:#B7CBE9; font-size:1px; line-height:1px;">&nbsp;</td><td width="275" align="center" style="padding:0 16px; color:#104AC6; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:18px; font-weight:700; letter-spacing:3px; white-space:nowrap;">TEKNİSYEN BİLGİLERİ</td><td style="height:1px; background-color:#B7CBE9; font-size:1px; line-height:1px;">&nbsp;</td></tr></table></td></tr><tr><td class="mobile-pad" style="padding:0 40px 34px; background-color:#FFFFFF;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#F7FAFE; border:1px solid #E3EAF3;"><tr><td style="padding:20px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="64" valign="top"><table role="presentation" width="58" height="58" cellspacing="0" cellpadding="0" border="0" style="width:58px; height:58px; background-color:#0F4BD8;"><tr><td align="center" valign="middle" style="color:#FFFFFF; font-family:Arial, Helvetica, sans-serif; font-size:19px; line-height:22px; font-weight:700;">'+esc(technicianCode)+'</td></tr></table></td><td valign="middle" style="padding-left:14px;"><div style="color:#0F1937; font-family:Arial, Helvetica, sans-serif; font-size:19px; line-height:25px; font-weight:700;">'+esc(technicianName)+'</div><div style="margin-top:2px; color:#5B6B8C; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:19px; font-weight:400;">Teknik Servis</div></td></tr></table><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:18px; padding-top:18px; border-top:1px solid #E3EAF3;"><tr><td width="36" valign="top" style="padding:0 12px 12px 0;"><table role="presentation" width="36" height="36" cellspacing="0" cellpadding="0" border="0" style="width:36px; height:36px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-phone" width="17" height="17" alt="" style="width:17px; height:17px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0 0 12px; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:20px; font-weight:400;"><a href="https://wa.me/'+phoneLink+'" style="color:#0F4BD8; text-decoration:none; font-weight:700;">'+esc(displayPhone)+'</a></td></tr><tr><td width="36" valign="top" style="padding:0 12px 0 0;"><table role="presentation" width="36" height="36" cellspacing="0" cellpadding="0" border="0" style="width:36px; height:36px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-mail" width="17" height="17" alt="" style="width:17px; height:17px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:20px; font-weight:400;"><a href="mailto:'+esc(technicianEmail)+'" style="color:#0F4BD8; text-decoration:none; font-weight:700; word-break:break-word;">'+esc(technicianEmail)+'</a></td></tr></table></td></tr></table></td></tr><tr><td class="mobile-pad" style="padding:36px 40px 0; background-color:#FFFFFF;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td class="footer-col" width="190" valign="top" style="padding:0 20px 26px 0;"><img src="cid:drama-makine-logo" width="118" alt="Drama Makine" style="width:118px; height:auto; margin-bottom:14px;"><p style="margin:0 0 8px; color:#0F1937; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px; font-weight:700;">Drama Makine ve Otomotiv Sanayi Ticaret A.Ş.</p><p style="margin:0; color:#5B6B8C; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:19px; font-weight:400;">Endüstriyel çözümlerimiz ve teknik servis hizmetlerimiz ile yanınızdayız.</p></td><td class="footer-col" width="240" valign="top" style="padding:0 16px 26px; border-left:1px solid #E3EAF3;"><div style="color:#104AC6; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:16px; font-weight:700; letter-spacing:2px; margin-bottom:16px;">BİZE ULAŞIN</div><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="40" valign="top" style="padding:0 12px 14px 0;"><table role="presentation" width="40" height="40" cellspacing="0" cellpadding="0" border="0" style="width:40px; height:40px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-phone" width="20" height="20" alt="Telefon" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0 0 14px; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:22px; font-weight:400;"><a href="tel:+902242435070" style="color:#0F4BD8; text-decoration:none; font-weight:700;">0 (224) 243 50 70</a></td></tr><tr><td width="40" valign="top" style="padding:0 12px 14px 0;"><table role="presentation" width="40" height="40" cellspacing="0" cellpadding="0" border="0" style="width:40px; height:40px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-mail" width="20" height="20" alt="E-posta" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0 0 14px; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:22px; font-weight:400;"><a href="mailto:info@dramamakine.com" style="color:#0F4BD8; text-decoration:none; font-weight:700;">info@dramamakine.com</a></td></tr><tr><td width="40" valign="top" style="padding:0 12px 14px 0;"><table role="presentation" width="40" height="40" cellspacing="0" cellpadding="0" border="0" style="width:40px; height:40px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-web" width="20" height="20" alt="Web" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0 0 14px; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:22px; font-weight:400;"><a href="https://www.dramamakine.com" style="color:#0F4BD8; text-decoration:none; font-weight:700;">www.dramamakine.com</a></td></tr><tr><td width="40" valign="top" style="padding:0 12px 0 0;"><table role="presentation" width="40" height="40" cellspacing="0" cellpadding="0" border="0" style="width:40px; height:40px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-pin" width="20" height="20" alt="Adres" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding:0 0 0; color:#202020; font-family:Arial, Helvetica, sans-serif; font-size:14.5px; line-height:22px; font-weight:400;"><span style="font-weight:400;">Hasanağa OSB. Mah. HOSAB Sanayi Cad. No:68<br>Nilüfer / BURSA</span></td></tr></table></td><td class="footer-col" width="150" valign="top" style="padding:0 0 26px 16px; border-left:1px solid #E3EAF3;"><div style="color:#104AC6; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:16px; font-weight:700; letter-spacing:2px; margin-bottom:16px;">BİZİ TAKİP EDİN</div><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td><a href="https://www.linkedin.com/company/drama-makine-ve-yedek-par%C3%A7a-sanayi-ve-ticaret-limited-%C5%9Firketi/posts/?feedView=all" style="text-decoration:none;"><table role="presentation" width="42" height="42" cellspacing="0" cellpadding="0" border="0" style="width:42px; height:42px; background-color:#0F1937; border-radius:50%; margin:0 10px 10px 0;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-linkedin" width="20" height="20" alt="LinkedIn" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></a></td><td><a href="http://www.youtube.com/@dramagroup7837" style="text-decoration:none;"><table role="presentation" width="42" height="42" cellspacing="0" cellpadding="0" border="0" style="width:42px; height:42px; background-color:#0F1937; border-radius:50%; margin:0 10px 10px 0;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-youtube" width="20" height="20" alt="YouTube" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></a></td><td><a href="https://www.instagram.com/dramagrouptr/" style="text-decoration:none;"><table role="presentation" width="42" height="42" cellspacing="0" cellpadding="0" border="0" style="width:42px; height:42px; background-color:#0F1937; border-radius:50%; margin:0 10px 10px 0;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-instagram" width="20" height="20" alt="Instagram" style="width:20px; height:20px; margin:0 auto; display:block;"></td></tr></table></a></td></tr></table></td></tr></table></td></tr><tr><td class="mobile-pad" style="padding:26px 40px 0; background-color:#FFFFFF; border-top:1px solid #E3EAF3;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td class="trust-col" width="33%" valign="top" style="padding:0 18px 0 0;"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td width="44" valign="top"><table role="presentation" width="44" height="44" cellspacing="0" cellpadding="0" border="0" style="width:44px; height:44px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-shield" width="21" height="21" alt="Güvenilir" style="width:21px; height:21px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding-left:12px; color:#0F1937; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:18px; font-weight:700;">Güvenilir Hizmet<div style="margin-top:3px; color:#5B6B8C; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:17px; font-weight:400;">Deneyimli teknik ekibimizle hızlı ve etkili çözümler.</div></td></tr></table></td><td class="trust-col" width="33%" valign="top" style="padding:0 18px 0 0;"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td width="44" valign="top"><table role="presentation" width="44" height="44" cellspacing="0" cellpadding="0" border="0" style="width:44px; height:44px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-check" width="21" height="21" alt="Kalite" style="width:21px; height:21px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding-left:12px; color:#0F1937; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:18px; font-weight:700;">Kalite Odaklı<div style="margin-top:3px; color:#5B6B8C; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:17px; font-weight:400;">Yüksek standartlarda servis anlayışı.</div></td></tr></table></td><td class="trust-col" width="33%" valign="top" style="padding:0 0 0 0;"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td width="44" valign="top"><table role="presentation" width="44" height="44" cellspacing="0" cellpadding="0" border="0" style="width:44px; height:44px; background-color:#0F1937; border-radius:50%;"><tr><td align="center" valign="middle" style="border-radius:50%;"><img src="cid:icon-headset" width="21" height="21" alt="Destek" style="width:21px; height:21px; margin:0 auto; display:block;"></td></tr></table></td><td valign="middle" style="padding-left:12px; color:#0F1937; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:18px; font-weight:700;">Destek Hattı<div style="margin-top:3px; color:#5B6B8C; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:17px; font-weight:400;">7/24 teknik destek ve bilgilendirme.</div></td></tr></table></td></tr></table></td></tr><tr><td align="center" style="padding:20px 24px 22px; background-color:#062B5A;"><p style="margin:0 0 4px; color:#B9CBEF; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; font-weight:400;">Bu e-posta otomatik olarak gönderilmiştir.<br>Bu e-posta gizlidir ve yalnızca ilgili kişilerle paylaşılmalıdır.</p><p style="margin:8px 0 0; color:#7C97C9; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:16px; font-weight:400;">© 2026 Drama Makine ve Otomotiv Sanayi Ticaret A.Ş. — Tüm hakları saklıdır.</p></td></tr></table></td></tr></table></body></html>';
}
